      ...
      <main className="min-h-screen p-8 pt-24 md:ml-64">
        <div className="max-w-4xl mx-auto">
          ...
          {activeTab === 'achievements' && (
            <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
              {achievements.length === 0 ? <p className="rounded-lg border border-slate-200 bg-white p-6 text-center text-slate-500">No pending extracurricular achievements to review.</p> : achievements.map((ach: any) => (
          ...
          {activeTab === 'meetings' && (
            <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
              {meetings.length === 0 ? <p className="rounded-lg border border-slate-200 bg-white p-6 text-center text-slate-500">No pending meeting logs to review.</p> : meetings.map((meeting: any) => (
